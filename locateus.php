...
<body style="background-image:url(img/pic.jpeg)">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a class="logo"><img src="img/logo.png" width="30px" height="30px"><strong> MedHelp </strong>Appointment Booking System</a></li>
			<li><a href="cover.php">Home</a></li>
		</ul>
	</div>
	<form action="locateus.php" method="post">
	<div class="sucontainer" style="background-color:#BBDEFB">
		<ul style="background-color:#BBDEFB">			
			<label style="color:#303F9F;"><b>Search Doctor</b></label>
		...
		<label style="font-size:20px;color:#303F9F;" >City:</label><br>
